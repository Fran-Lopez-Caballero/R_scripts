...
library(ggplot2)
#library(corrplot)
rda <- function(){ return('/Volumes/Path/Path/Project/') }
source('~/Private/r-compile/Path/R/Path.R')
source('~/Private/r-compile/Path/R/Path.R')
source('~/Private/Project/r-files/functions/functions_Project.R')
source('~/Private/Project/r-filesUser/load_Project_Human.R')

# Define variables
Subject_list <- c('xxxx','xxxx')  #
...
for (subid in 1:length(Subject_list)) {
  ...
  for (w in 1:length(Wave_list)) {
    ...
    if (file.exists(paste("/Volumes/Path/Path/Project/Path/PathFit",Subject, "Project",Subject,Parcel,Hemisphere,Wave,"gd.rda",sep="_"))){
      # Load the model fit variable
      load(paste("/Volumes/Path/Path/Project/Path/PathFit",Subject, "Project",Subject,Parcel,Hemisphere,Wave,"gd.rda",sep="_"))
      # Extract fit values
...
# Save variables
save(Mega_variable_param_v1, file = paste("~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/EEG_Mega_variable_param_v1",sep=""))
save(Mega_variable_param_v2, file = paste("~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/EEG_Mega_variable_param_v2",sep=""))
save(Mega_variable_corr, file = paste("~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/EEG_Mega_variable_corr",sep=""))
...
ggsave(
  ...
  plot = plot_heatmap,
  device = "png",
  path = "~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/",
  scale = 5,
  width = NA,
  height = NA,
  units = "cm",
...
for (parc in 1:length(Parcel_list)) {
  ...
  for (hem in 1:length(Hemisphere_list)) {
    ...
    for (w in 1:length(Wave_list)) {
      Wave <- Wave_list[w]
      if (file.exists(paste(paste("/Volumes/Path/Path/Project/Path/PathFit",Subject, "Project",Subject,Parcel,Hemisphere,Wave,"gd.rda",sep="_")))) {
        # Load the model fit variable
        load(paste("/Volumes/Path/Path/Project/Path/PathFit",Subject, "Project",Subject,Parcel,Hemisphere,Wave,"gd.rda",sep="_"))
        # Extract fit values
        Mega_variable_param_v1[[subid,pos_col]] <-  modelFit[['par']][1]
    ...
    save(Mega_variable_param_v1, file = paste("~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/",Parcel,"_",Hemisphere,"_Mega_variable_param_v1",sep=""))
    save(Mega_variable_param_v2, file = paste("~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/",Parcel,"_",Hemisphere,"_Mega_variable_param_v2",sep=""))
    save(Mega_variable_corr, file = paste("~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/",Parcel,"_",Hemisphere,"_Mega_variable_corr",sep=""))  
...
save(Mega_variable_ind_sub, file = paste("~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/Within_subjects/",Subject,"_Mega_variable",sep=""))  
# save(Mega_variable_ind_sub_corr, file = paste("~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/Within_subjects/",Subject,"_Mega_variable_corr",sep=""))  
...
if (1 == 1) { # Silly way to compress a long section
  ...
  ggsave(
    ...
    plot = plot_heatmap,
    device = "png",
    path = "~/Private/Project/r-filesUser/FiguPath/Summary_parameters/Project/Within_subjects/",
    scale = 5,
    width = NA,
    height = NA,
    units = "cm",
